...
public class PermissionPrefData {
    private static WeakReference<PermissionPrefData> instance;
    protected final Context context;
    private final SharedPreferences pref;

    public PermissionPrefData(Context context, String name) {
        this.context = context;
        this.pref = context.getSharedPreferences(name, Context.MODE_PRIVATE);
    }

    public static PermissionPrefData instance(Context context) {
        if (instance == null || instance.get() == null) {
            instance = new WeakReference<>(new PermissionPrefData(context, "ms_permission"));
        }
        return instance.get();
    }
